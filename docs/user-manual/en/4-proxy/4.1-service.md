...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (AutoTier)
...
After starting the proxy and enabling app takeover, AutoTier modifies app configurations:
...
When stopping the proxy, AutoTier will:
