...
| OpenCode    | OpenCode Model | System default | Available in the current build, auto-detected via npm package mapping |
| OpenClaw    | OpenClaw Model | System default | Available in the current build, covers all protocol variants and custom auth-header |
