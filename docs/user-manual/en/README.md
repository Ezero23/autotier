...
- Applicable to AutoTier v0.1.6+

### Current Version Capabilities

- **AutoTier Shadow routing**: Off / Shadow observation, candidate slot resolution, copy-only legacy import, and optional vision copilot. See [v0.1.6 release notes](../../release-notes/v0.1.6-en.md)
