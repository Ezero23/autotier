...
//!
//! Parses autotier:// URLs into DeepLinkImportRequest structures.
...
/// AutoTier deep-link scheme used for configuration imports.
pub const DEEPLINK_SCHEME: &str = "autotier";

/// Parse an autotier:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// autotier://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != DEEPLINK_SCHEME {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected '{DEEPLINK_SCHEME}', got '{scheme}'"
        )));
    }
