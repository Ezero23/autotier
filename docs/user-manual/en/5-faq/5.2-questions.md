...
The current AutoTier macOS build is unsigned and not notarized. Download `AutoTier-v0.1.6-macOS.zip` from the [Releases page](https://github.com/Ezero23/autotier/releases); on first launch, you may need to right-click the app and choose **Open**, or allow it in macOS Privacy & Security settings.
