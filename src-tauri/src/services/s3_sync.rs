...
/// Example: `autotier-sync/v2/db-v6/default/manifest.json`
...
mod tests {
    ...
    fn test_settings() -> S3SyncSettings {
        S3SyncSettings {
            remote_root: "autotier-sync".to_string(),
    ...
    fn s3_key_uses_v2_and_correct_format() {
        ...
        assert_eq!(key, "autotier-sync/v2/db-v6/default/manifest.json");
    }
    ...
    fn s3_key_matches_expected_pattern() {
        ...
        assert_eq!(parts[0], "autotier-sync");
