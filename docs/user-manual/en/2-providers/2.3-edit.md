...
AutoTier provides rich icon customization features:
...
This ensures AutoTier and CLI tool configurations stay in sync.
...
When adding a provider, AutoTier automatically extracts endpoint URLs from the configuration.
