...
AutoTier is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**.
...
AutoTier solves these problems through a unified interface.
...
AutoTier is built with a modern technology stack:
