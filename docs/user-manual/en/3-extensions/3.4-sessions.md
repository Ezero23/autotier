...
**On macOS:**
- AutoTier launches your preferred terminal with the resume command
...
In current AutoTier builds, **Claude sessions** show a **directory picker** before resume, allowing you to override the default project directory. Useful when:
...
3. AutoTier launches the Claude terminal session in the selected directory
