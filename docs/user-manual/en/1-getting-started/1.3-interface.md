...
In current AutoTier builds, some Claude Code and Codex provider cards also show a **Local Routing support badge**, helping you quickly identify providers that can be served through local routing.
...
AutoTier displays an icon in the system tray, providing quick access to operations.
