        ...
        for item in page.items {
            if let Some(detail) = db.autotier_get_decision_detail(&item.decision_id)? {
                rows.push(AutotierDecisionRow {
                    ...
                    vision_fallback_applied: detail.vision_fallback_applied,
                    vision_describe_input_tokens: detail.vision_describe_input_tokens,
                    vision_describe_output_tokens: detail.vision_describe_output_tokens,
