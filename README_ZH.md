...
当前 AutoTier macOS 构建未签名、未公证，正式 Release 提供 `AutoTier-v0.1.5-macOS.zip`。首次启动可能需要右键选择“打开”，或在 macOS“隐私与安全性”中手动允许。
...
从 [Releases](https://github.com/Ezero23/autotier/releases) 页面下载 `AutoTier-v0.1.5-macOS.zip`；当前未签名版本不发布 DMG。解压得到 `AutoTier.app` 后，将其拖入“应用程序”。首次启动可能需要右键选择“打开”，或在 macOS“隐私与安全性”中手动允许。
