...
fn detail_from_row(
    ...
    AutotierDecisionDetail {
        ...
        vision_fallback_applied: row.vision_fallback_applied,
        vision_describe_input_tokens: row.vision_describe_input_tokens,
        vision_describe_output_tokens: row.vision_describe_output_tokens,
...
const DECISION_SELECT: &str = "SELECT d.decision_id, d.created_at, d.completed_at, d.app_type, d.session_id_hash, d.mode,
                        ...
                        d.vision_fallback_applied, d.vision_describe_input_tokens,
                        d.vision_describe_output_tokens,
